...
exports.fullContact = (req, res) => {
  ...
  const format = (obj) => {
    ...
    ret.Owler = obj.socialProfiles.find((prof) => prof.typeName === 'Owler');
    ...
    ret.CrunchBase = obj.socialProfiles.find((prof) => prof.typeName === 'CrunchBase');
    ...
    ret.ranks = [];
    obj.traffic.ranking.map((x) => {
      const object = {}
      object[x.locale] = x.rank;
      ret.ranks.push(object)
    });
    return ret;
  };
