...
//   }
//
// // set initial state with job status as empty string
// // make route & func to grab user id and send back saved job status data
// // make call to get that data in lifecycle method so it renders on pagelaod
// //   set state with that data
// // set chart data object to the job status state ^
// // render chart with display props
//
//   // componentWillMount() {
//   //
//   // }
